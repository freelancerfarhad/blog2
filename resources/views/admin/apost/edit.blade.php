...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form action="{{route('apost.update',$posts->id)}}" method="post"enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="card">
                    ...
                    <div class="body">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="name" class="form-control"name="short"value="{{$posts->short}}">
                    ...
                    <div class="body">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                ...
                                <input type="text" id="name" class="form-control"name="short"value="{{$posts->atitle}}">
                            </div>
                        </div>
